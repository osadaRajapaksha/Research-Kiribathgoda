...
print("--- SCRIPT 4: SMOTE + TUNED XGBOOST WITH SMOTE TEST DATA ---")
...
print("3. Tuning SMOTE + XGBoost with GridSearch...")
...
test_df.to_csv('QGIS_Predictions_3_SMOTE_Tuned_XGB.csv', index=False)
print("Saved -> 'QGIS_Predictions_3_SMOTE_Tuned_XGB.csv'")
...
plt.tight_layout()
plt.savefig('Matrix_3_SMOTE_Tuned_XGB.png', dpi=300)
print("Saved -> 'Matrix_3_SMOTE_Tuned_XGB.png'")
...
smote_test_export_df.to_csv('SMOTE_Combined_Testing_Data_XGB.csv', index=False)
print(f"Saved -> 'SMOTE_Combined_Testing_Data_XGB.csv'")
...
plt.xlabel('Algorithm Prediction')
plt.tight_layout()
plt.savefig('Matrix_4_SMOTE_Testing_Data_XGB.png', dpi=300)
print("Saved -> 'Matrix_4_SMOTE_Testing_Data_XGB.png'")
